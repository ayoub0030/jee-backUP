...
public class PostService {
    ...
    static {
        posts.add(new Post(1L, "مكتب السياسي للأحرار يتمسّك بـمنجزات الحكومة", "عبد العزيز أكرام", "\n" +
                "هسب   ريس\n" +
                "سياسة\n" +
        ...
        posts.add(new Post(3L, "تراجع طفيف لأثمنة الخضر", "عماد السنوني", "في سياق متصل، بلغ ثمن البطاطس في حده الأقصى 3,5 دراهم؛ في حين أن البصل لا تزال قيمة الكيلوغرام الواحد منه تلامس 9 دراهم، بينما وصل ثمن القرع الأخضر إلى 7,5 دراهم في الحد الأقصى و4,5 دراهم في الحد الأدنى.\n" +
                "\n" +
        ...
        posts.add(new Post(5L, "Le Nigéria s'allie au Maroc pour investir 10 milliards de dollars dans les énergies renouvelables", "Hespress FR", "L'État de Kano, au Nigéria, prévoit d'attirer plus de 10 milliards de dollars d'investissements dans le secteur des énergies renouvelables et des ressources minières solides au cours des cinq prochaines années, grâce à un partenariat stratégique avec plusieurs entreprises marocaines de renom."));

        posts.add(new Post(4L, "Angleterre : Le milliardaire marocain Anas Sefrioui envisage de racheter Sheffield Wednesday", "Hespress FR", "Le milliardaire marocain Anas Sefrioui, l'une des plus grandes fortunes du continent africain, envisage de racheter un club de football en Angleterre. Selon les informations rapportées par The Sun, son attention se porte actuellement sur Sheffield Wednesday, club historique évoluant en Championship."));
